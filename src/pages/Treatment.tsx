                                            ...
                                            <ClearableTextField
                                                ...
                                                sx={{
                                                    '& .MuiInputBase-root': {
                                                        height: '38px',
                                                        fontSize: '13px',
                                                        backgroundColor: isFormDisabled ? '#f5f5f5 !important' : 'inherit'
                                                    },
                                                    '& .MuiInputBase-input': {
                                                        backgroundColor: isFormDisabled ? '#f5f5f5 !important' : 'inherit',
                                                        WebkitTextFillColor: isFormDisabled ? '#555 !important' : 'inherit'
                                                    }
                                                }}
                                            />
                                        </div>
                                                    ...
                                                    <ClearableTextField
                                                        ...
                                                        sx={{
                                                            ...
                                                            '& .MuiInputBase-root': {
                                                                height: '38px',
                                                                fontSize: '13px',
                                                                backgroundColor: (key === 'bmi' || isFormDisabled) ? '#f5f5f5 !important' : 'inherit'
                                                            },
                                                            '& .MuiInputBase-input': {
                                                                padding: '6px 10px',
                                                                fontSize: '13px',
                                                                backgroundColor: (key === 'bmi' || isFormDisabled) ? '#f5f5f5 !important' : 'inherit',
                                                                WebkitTextFillColor: (key === 'bmi' || isFormDisabled) ? '#555 !important' : 'inherit'
                                                            }
                                                        }}
                                                    />
                                                </div>
